...
- Three output formats per recording session:
  - `pipeline_features_timeseries.csv` — one row per video frame
  - `pipeline_features.csv` — per-recording summary statistics
  - `pipeline_features.json` — full nested JSON with raw arrays
